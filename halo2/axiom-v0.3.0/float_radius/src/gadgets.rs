/*
 Author: Wentao Xiao (https://github.com/DCMMC)
 See: https://github.com/DCMMC/halo2-scaffold/blob/main/src/gadget/fixed_point.rs
 Copied here rather than imported via a package dependency
 for compatibility reasons with Axiom's halo2-lib version 0.3.0
*/
