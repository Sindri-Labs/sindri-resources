...
// This function uploads the circuit to Sindri for compilation and outputs the circuit details in the /data/ directory.
...
// This function verifies the proof using the proof data generated by Sindri and was saved locally in the /data/ directgory.
...
// This function creates a header map with the API key and the Accept header set to application/json.
